...
void main() {
  group('PerformanceMonitor', () {
    ...
    test('recordEventDispatch adds event', () {
      ...
      final stats = monitor.getStatistics();
      expect(stats.recentEvents.length, 1);
      expect(stats.recentEvents.first.type, PerformanceEventType.eventDispatched);
    ...
    test('TaskMetrics toString', () {
      final metrics = TaskMetrics(taskId: 't', workerType: 'w', startTime: DateTime.now());
    ...
    test('PerformanceEvent toString', () {
      ...
      expect(event.toString(), contains('type: PerformanceEventType.taskStarted'));
