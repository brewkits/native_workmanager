...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Native WorkManager v1.1.2 Demo',
      theme: ThemeData(
...
class _DemoHomePageState extends State<DemoHomePage>
  ...
  void initState() {
    ...
    _addLog('🚀 Native WorkManager v1.1.2 initialized (kmpworkmanager v2.3.9)');
  }
  ...
  // ═══════════════════════════════════════════════════════════════
  // TAB 2: v1.1.2 Features - BackoffPolicy
  // ═══════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════
  // TAB 3: v1.1.2 Features - ContentUri (Android only)
  // ═══════════════════════════════════════════════════════════════
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Native WorkManager v1.1.2'),
  ...
  Widget _buildBackoffPolicyTab() {
    return ListView(
      padding: const EdgeInsets.all(16),
      children: [
        const _SectionTitle('v1.1.2: Intelligent Retry (Android)'),
        const Text(
  ...
  Widget _buildContentUriTab() {
    return ListView(
      padding: const EdgeInsets.all(16),
      children: [
        const _SectionTitle('v1.1.2: ContentUri Trigger (Android)'),
        const Text(
